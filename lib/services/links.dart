...
class Links {
  static List<WatchLink> forTitle(String title, {int? year}) {
    ...
    final web = Uri.encodeQueryComponent('$clean anime streaming vostfr vf');
    final trailer = Uri.encodeQueryComponent('$clean$suffix anime trailer');
    ...
    return [
      ...
      WatchLink('Crunchyroll', 'https://www.crunchyroll.com/search?q=$plain'),
      WatchLink('ADN', 'https://animationdigitalnetwork.com/search?q=$plain'),
      WatchLink('Netflix', 'https://www.netflix.com/search?q=$plain'),
      WatchLink('Prime Video', 'https://www.primevideo.com/search/?phrase=$plain'),
      WatchLink('AniList', 'https://anilist.co/search/anime?search=$plain'),
